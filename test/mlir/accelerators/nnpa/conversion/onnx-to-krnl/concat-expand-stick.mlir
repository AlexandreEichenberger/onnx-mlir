...
// Dedicated lowering for the zhigh.concat-expand-stick FusedOp kind (the
// single-output case, i.e. yieldConcatResult = false -- see
// concat-expand-stick-unfuse.mlir for the yieldConcatResult = true case,
// which still falls back to the generic inline lowering).
//
